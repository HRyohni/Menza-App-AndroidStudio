...
public class CustomBaseAdapter extends BaseAdapter {
    ...
    public CustomBaseAdapter(Context ctx,String [] nazivjela,String [] cijenajela, String [] sadrzajjela)
    {
        this.context = ctx ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView background = (ImageView) convertView.findViewById(R.id.imageView7);
        ...
        background.setImageResource(R.drawable.foodbox);
        return convertView;
    }
}
